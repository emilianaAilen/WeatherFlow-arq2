...
export const UpdateUserRequestSchema = z
  .object({
    name: z
      ...
      .min(1)
      .optional()
      .openapi({ example: 'Jane', description: 'First name of the user' }),
    surname: z
      .string()
      .min(1)
      .optional()
      .openapi({ example: 'Doe', description: 'Last name of the user' }),
    email: z
      .email()
      .optional()
      .openapi({ example: 'jane@example.com', description: 'Unique email address' }),
  })
